...
$sayfa = isset($_GET['sayfa']) && is_numeric($_GET['sayfa']) ? $_GET['sayfa'] : 1; // sayfa değeri sayıysa 
if ($sayfa <= 0){
    $sayfa = 1;
}
...
// toplam sayfa sayısı
$toplamSayfa = ceil($toplamVeri / $limit); // ceil değeri ondalıklı sayıların çıkmasının önlenmesi için yukarı yuvarlar
